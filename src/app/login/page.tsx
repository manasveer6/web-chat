...
export default function Login() {
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 flex">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen md:w-1/2 lg:py-0">
        <a
          href="#"
      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 me-auto md:h-screen md:w-1/2 lg:py-0">
        <h1 className="text-4xl mb-2">Chat Anonymously</h1>
        <p className="p-4 mb-3">
          Start chatting anonymously! No login required – just dive in and
          connect instantly.
        </p>
        <button
